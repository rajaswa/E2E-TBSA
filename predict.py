...
if __name__ == '__main__':
    ...
    parser.add_argument("-optimizer", type=str, default="adam", help="optimizer (or, trainer)") #or sgd
    parser.add_argument("-n_epoch", type=int, default=50, help="number of training epoch") #was 40
    ...
    emb_path = 'embeddings/glove.840B.300d.txt'#emb2path[emb_name]
